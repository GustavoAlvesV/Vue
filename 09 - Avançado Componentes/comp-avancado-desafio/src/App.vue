<template>
  <div id="app">
    ...
    <component :is="componente">  <!-- :is="componente" =>  Define o componente -->
		<span> Conteúdo do Componente <strong> {{componente}} </strong></span>  <!-- {{componente}} => Imprimi o nome do componente -->
	</component>
