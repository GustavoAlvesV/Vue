<template>
  <div id="app">
    <usuario-lista :usuarios="usuarios"/> <!-- Barramento -->
    <usuario-detalhe />   <!-- Barramento -->
<!--    <usuario-lista :usuarios="usuarios" @usuarioSelecionado="usuario = $event" /> => Por evento personalizado-->
<!--	<usuario-detalhe :usuario="usuario" />    => Por evento personalizado-->
  </div>
</template>
